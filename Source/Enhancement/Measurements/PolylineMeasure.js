define([
    ...
    /**
     * The signature of the event generated by {@link PolylineMeasure#linePainted}.
     * @function
     * @param {Object} addedPolyline The painted polyline Entity and length DOMLabel, {line: {@link Entity}, label: {@link DOMLabel}}.
     * @param {Object[]} addedLabels The painted middle frag line length label when {@link PolylineMeasure#showFragLength} is true.
     * If not have label will return undefined, else return {label: {@link DOMLabel}}[].
     */
    PolylineMeasure.linePaintedEventCallback = undefined;
    ...
    defineProperties(PolylineMeasure.prototype, {
        ...
        /**
         * Gets the event that is fired when drawing finished.
         * The generated event is a {@link PolylineMeasure.linePaintedEventCallback}.
         * 
         * @memberof PolylineMeasure.prototype
         * @readonly
         * @type {Event}
         ...
         * 
         * // Get the event
         * var linePaintedEvent = polylineMeasure.linePainted;
         * 
         * // Implement the handler
         * function linePaintedHandler(addedPolyline, addedLabels) {
         *    console.log(addedPolyline, addedLabels);
         * }
         * 
    ...
    function updateTotalLength(tool) {
        ...
        if (tool._showFragLength) {
            var lengthLabel = tool._labelCollection.add({
                name: 'plc-polyline-measure-painte-m-' + tool._paintedPolylines.length,
    ...
    function paintPolyline(tool) {
        ...
        var lengthLabel = tool._labelCollection.add({
            name: 'plc-polyline-measure-painte-' + tool.paintedPolylines.length,
        ...
        var addedPolyline = tool._paintedPolylines[tool._paintedPolylines.length - 1];
        var addedLabels = tool._status.lastLabels.length > 0 ? tool._status.lastLabels : undefined;
        tool._linePainted.raiseEvent(addedPolyline, addedLabels);
    }
