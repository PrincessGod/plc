define([
    ...
    /**
     * Provides tiled text label imagery hosted by Tianditu MapServer.
     ...
     *
     * @example
     * // Add Tianditu text layer to viewer
     * var tiandituTextProvider = new Cesium.PLC.TiandituTextImageryProvider();
    ...
    defineProperties(TiandituTextImageryProvider.prototype, {
        /**
         * Gets the options of TiandituTextImageryProvider
         * @memberof TiandituTextImageryProvider.prototype
         * @type {Object}
         * @readonly
         */
        options: {
        ...
        /**
         * Gets the {@link WebMapTileServiceImageryProvider} of TiandituTextImageryProvider.
         * @memberof TiandituTextImageryProvider.prototype
    ...
    return TiandituTextImageryProvider;
});
